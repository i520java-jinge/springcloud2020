 ...
 */
@Component
@FeignClient(value = "CLOUD-PAYMENT-HYSTRIX-SERVICE",fallback = PaymentFeignForBackService.class) //CLOUD-PAYMENT-SERVICE 是支付模块的服务名称
